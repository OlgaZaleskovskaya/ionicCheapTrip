...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "transportIconMap", function() { return transportIconMap; });
var Icons;
(function (Icons) {
...
/* harmony import */ var _places_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./places.model */ "./src/app/places/places.model.ts");
...
let PlacesService = class PlacesService {
    ...
    getPaths(startPoint, endPoint) {
        ...
        this.httpSrv
            ...
            const sortedPaths = transformedPaths.sort((a, b) => +a.euro_price - +b.euro_price);
    ...
    transformPathDetails(paths) {
        const transformed = paths.map((path) => {
            return Object.assign(Object.assign({}, path), { duration_minutes: this.transformDuration(path.duration_minutes.toString()), euro_price: this.transformPrice(path.euro_price.toString()), imgUrl: _places_model__WEBPACK_IMPORTED_MODULE_8__["transportIconMap"].get(path.transportation_type), transportation_type: this.translate.instant(`TRANSPORTATION_TYPE.${path.transportation_type}`) });
        });
        return transformed;
    }
    transformPath(path) {
    ...
    getCurrencyRate(cur, recalculate) {
...
MapModalComponent.propDecorators = {
    mapElementRef: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ["map",] }]
};
MapModalComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-map-modal",
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./map-modal.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/map-modal/map-modal.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./map-modal.component.scss */ "./src/app/shared/map-modal/map-modal.component.scss")).default]
    })
], MapModalComponent);
...
let LocationPickerComponent = class LocationPickerComponent {
    ...
    ngOnInit() { }
    onPickLocation() {
        this.modalCtrl.create({ component: _map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_3__["MapModalComponent"] }).then(modalEl => modalEl.present());
    }
};
...
LocationPickerComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./location-picker.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/pickers/location-picker/location-picker.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./location-picker.component.scss */ "./src/app/shared/pickers/location-picker/location-picker.component.scss")).default]
    })
...
/* harmony import */ var _map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./map-modal/map-modal.component */ "./src/app/shared/map-modal/map-modal.component.ts");
/* harmony import */ var _pickers_location_picker_location_picker_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./pickers/location-picker/location-picker.component */ "./src/app/shared/pickers/location-picker/location-picker.component.ts");
/* harmony import */ var _tools_tools_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../tools/tools.component */ "./src/app/tools/tools.component.ts");
...
let ToolsComponent = class ToolsComponent {
    constructor(placesSrv, translate) {
...
ToolsComponent.propDecorators = {
    isHidden: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }]
};
ToolsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-tools",
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./tools.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/tools/tools.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./tools.component.scss */ "./src/app/tools/tools.component.scss")).default]
    })
], ToolsComponent);
...
//# sourceMappingURL=default~contact-contact-module~places-places-module-es2015.js.map