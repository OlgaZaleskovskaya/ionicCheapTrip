(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~contact-contact-module~places-places-module"], {
    /***/
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppToolsToolsComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppHttpServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var HttpService = /*#__PURE__*/function () {
        ...
        _createClass(HttpService, [{
          ...
          key: "getCurencyRate",
          value: function getCurencyRate(cur) {
            console.log('cur', cur);
            var curUrl = "https://free.currconv.com/api/v7/convert?q=EUR_".concat(cur, "&compact=ultra&apiKey=31d8c7a521820803e1aa");
    ...
    /*! exports provided: Icons, transportIconMap */

    /***/
    function srcAppPlacesPlacesModelTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "transportIconMap", function () {
        return transportIconMap;
      });
      ...
      (function (Icons) {
        ...
        Icons["CAR_FERRY"] = "<span class=\"material-icons\">\n    directions_boat\n    </span>";
        Icons["WALK"] = "<span class=\"material-icons\">\n    directions_walk\n    </span>";
        Icons["TOWN_CAR"] = "<span class=\"material-icons\">\n    directions_car\n    </span>";
        Icons["TAXI"] = "<span class=\"material-icons\">\n    local_taxi\n    </span>";
        Icons["SHUTTLE"] = "<span class=\"material-icons\">\n    shuttle\n    </span>";
        Icons["DRIVE_CAR"] = "<span class=\"material-icons\">\n    directions_car\n    </span>";
        Icons["RIDE_SHARE"] = "<span class=\"material-icons\">\n    groups\n    </span>";
      })(Icons || (Icons = {}));
    ...
    function srcAppPlacesPlacesServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _places_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./places.model */
      "./src/app/places/places.model.ts");
      ...
      var currencyArray = new Map();
      currencyArray.set("EUR", {
        name: "Euro",
        rate: 1
      });
      currencyArray.set("USD", {
        name: "USD",
        rate: 0
      });
      currencyArray.set("RUB", {
        name: "RUB",
        rate: 0
      });
      currencyArray.set("RUB", {
      ...
      var PlacesService = /*#__PURE__*/function () {
        function PlacesService(httpSrv, alertCtrl, router, translate) {
          ...
          this.currencyChanged$ = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        }
        ...
        _createClass(PlacesService, [{
          ...
          value: function getStartPointAutocomplete(str) {
            ...
            return this.getCitiesAutocomplete(str).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (res) {
              ...
              if (!str.match(re)) {
                _this10.errorHandler("LATIN_CHARACTERES");
              } else if (res.length == 0) {
                _this10.errorHandler("NO_RESULTS_FOR_SEARCH");
              }
            }));
          }
        }, {
          ...
          value: function getEndPointAutocomplete(str) {
            ...
            return this.getCitiesAutocomplete(str).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (res) {
              ...
              if (!str.match(re)) {
                _this11.errorHandler("LATIN_CHARACTERES");
              } else if (res.length == 0) {
                _this11.errorHandler("NO_RESULTS_FOR_SEARCH");
              }
            }));
          }
        }, {
          ...
          value: function getPaths(startPoint, endPoint) {
            ...
            this.httpSrv.getPaths(startPoint.id, endPoint.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (data) {
              ...
              var transformedPaths = pathsArr.map(function (path) {
                return _this12.transformPath(path);
              });
              var sortedPaths = transformedPaths.sort(function (a, b) {
                return +a.euro_price - +b.euro_price;
              });
              _this12.currentPaths = sortedPaths;
              return sortedPaths;
            })).subscribe(function (paths) {
              _this12.paths = paths;

              if (paths.length === 0) {
                _this12.errorHandler("NO_RESULTS_FOR_SEARCH");

                _this12.cleanPathsSubj$.next(true);

                _this12.pathsSubj$.next([]);

                return;
              } else {
                _this12.pathsSubj$.next(_this12.paths);
              }
            }), function (_error) {
              _this12.errorHandler("SLEEPING_SERVER");
            ...
            this.alertCtrl.create({
              ...
              buttons: [{
                ...
                handler: function handler() {
                  _this13.router.navigate(["/places/tabs/discover"]);
                }
              }]
          ...
          value: function transformPathDetails(paths) {
            ...
            var transformed = paths.map(function (path) {
              return Object.assign(Object.assign({}, path), {
                duration_minutes: _this14.transformDuration(path.duration_minutes.toString()),
                euro_price: _this14.transformPrice(path.euro_price.toString()),
                imgUrl: _places_model__WEBPACK_IMPORTED_MODULE_8__["transportIconMap"].get(path.transportation_type),
                transportation_type: _this14.translate.instant("TRANSPORTATION_TYPE.".concat(path.transportation_type))
              });
            });
            return transformed;
          }
          ...
          value: function transformPrice(price) {
            ...
            var pr = euro * this.currentCurrencyRate;
            return +pr;
          }
        }, {
          ...
          key: "getCurrencyRate",
          value: function getCurrencyRate(cur, recalculate) {
            var _this15 = this;

            this.currentCurrency = cur;
            this.httpSrv.getCurencyRate(cur).subscribe(function (res) {
              var previousCurrencyRate = _this15.currentCurrencyRate;
              _this15.currentCurrencyRate = +Object.values(res)[0];

              if (recalculate) {
                _this15.currencyChanged$.next({
                  name: _this15.currentCurrency,
                  rate: _this15.currentCurrencyRate,
                  previousRate: previousCurrencyRate
                });
              }
            }), function (_error) {
              _this15.errorHandler("SLEEPING_SERVER");

              _this15.pathsSubj$.next([]);
            };
          }
        }, {
          key: "setLanguage",
          value: function setLanguage(lang, changed) {
        ...
        _createClass(MapModalComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.getGoogleMaps().then(function (googleMaps) {
              var mapEl = _this16.mapElementRef.nativeElement;
              ...
              googleMaps.event.addListenerOnce(map, "idle", function () {
                _this16.renderer.addClass(mapEl, "visible");
              });
    ...
    function srcAppSharedSharedModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./map-modal/map-modal.component */
      "./src/app/shared/map-modal/map-modal.component.ts");
      /* harmony import */


      var _pickers_location_picker_location_picker_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      SharedModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_pickers_location_picker_location_picker_component__WEBPACK_IMPORTED_MODULE_9__["LocationPickerComponent"], _map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_8__["MapModalComponent"], _tools_tools_component__WEBPACK_IMPORTED_MODULE_10__["ToolsComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_4__["MatExpansionModule"], _angular_router__WEBPACK_IMPORTED_MODULE_11__["RouterModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateModule"].forChild({
          loader: {
        ...
        exports: [_pickers_location_picker_location_picker_component__WEBPACK_IMPORTED_MODULE_9__["LocationPickerComponent"], _map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_8__["MapModalComponent"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateModule"], _tools_tools_component__WEBPACK_IMPORTED_MODULE_10__["ToolsComponent"]],
        entryComponents: [_map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_8__["MapModalComponent"]]
      })], SharedModule);
    ...
    /***/
    function srcAppToolsToolsComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "a {\n  display: block;\n  text-decoration: none;\n  font-family: Lato, sans-serif;\n  font-style: italic;\n  width: 10rem;\n  text-align: center;\n  background-color: var(--ion-color-secondary);\n  color: white;\n  margin: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    function srcAppToolsToolsComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ToolsComponent = /*#__PURE__*/function () {
        function ToolsComponent(placesSrv, translate) {
        ...
        _createClass(ToolsComponent, [{
          ...
          value: function onSelectCurrency(event) {
            var cur = event["detail"]["value"];
      ...
      ToolsComponent.propDecorators = {
        isHidden: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"]
        }]
      };
      ToolsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-tools",
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./tools.component.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/tools/tools.component.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./tools.component.scss */
        "./src/app/tools/tools.component.scss"))["default"]]
      })], ToolsComponent);
      /***/
    }
  }]);
})();
//# sourceMappingURL=default~contact-contact-module~places-places-module-es5.js.map