...
const routes = [
    ...
    {
        path: "places",
        loadChildren: () => Promise.all(/*! import() | places-places-module */[__webpack_require__.e("default~contact-contact-module~places-places-module"), __webpack_require__.e("places-places-module")]).then(__webpack_require__.bind(null, /*! ./places/places.module */ "./src/app/places/places.module.ts")).then((m) => m.PlacesPageModule),
    },
    {
        path: "contact",
