...
const routes = [
    ...
    { path: 'places', loadChildren: () => __webpack_require__.e(/*! import() | places-places-module */ "places-places-module").then(__webpack_require__.bind(null, /*! ./places/places.module */ "./src/app/places/places.module.ts")).then(m => m.PlacesPageModule) },
];
