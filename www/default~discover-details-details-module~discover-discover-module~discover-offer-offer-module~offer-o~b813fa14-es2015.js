...
let PlacesService = class PlacesService {
    constructor(httpSrv, alertCtrl, router) {
    ...
    getPaths(startPoint, endPoint) {
        ...
        this.httpSrv
            ...
            const pathsArr = data.body.filter((path) => path.duration_minutes != "0");
    ...
    transformPath(path) {
        const transformedPath = Object.assign(Object.assign({}, path), { duration_minutes: this.transformDuration(path.duration_minutes.toString()), euro_price: this.transformPrice(path.euro_price.toString()), direct_paths: this.transformPathDetails(path.direct_paths), imgUrl: iconMap.get(path.routeType) });
...
/* harmony import */ var _pickers_location_picker_location_picker_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pickers/location-picker/location-picker.component */ "./src/app/shared/pickers/location-picker/location-picker.component.ts");
...
//# sourceMappingURL=default~discover-details-details-module~discover-discover-module~discover-offer-offer-module~offer-o~b813fa14-es2015.js.map